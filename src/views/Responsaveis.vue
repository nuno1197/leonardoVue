<template>
    <div id="responsaveis" :style="{ 'background-color': bgCode }">
        <appHeader :ajuda='ajuda'></appHeader>
        <navDraw></navDraw>
        <v-toolbar :style="{ 'background-color': bgCode }" style="padding-top:100px;">
            <div style="flex: 1; padding-left: 12px;">
                <v-toolbar-title :style="{ 'color': letterCode }" style="font-weight: bold;">Responsáveis</v-toolbar-title>
            </div>
            <v-divider
                class="mx-4"
                inset
            ...
            <span>Adicionar Responsavel</span>
            </v-tooltip>
        </v-toolbar>
...
const items: Item[] = [
    {username:"diretor",nome:"diretor",email:"diretor@uminho.pt",tipo:"Admin"},
    {username:"professor",nome:"professor",email:"professor@uminho.pt",tipo:"Admin"},
    {username:"admin",nome:"admin",email:"admin@admin.pt",tipo:"Admin"},
];
